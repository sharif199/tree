...
public abstract class OSDUAssert {
    ...
    public static void state(boolean expression, String message) {
        if (!expression) {
            throw new AppException(HttpStatus.SC_BAD_REQUEST, "IllegalStateException", message);
        }
    }
    ...
    public static void isTrue(boolean expression, String message) {
        if (!expression) {
            throw new AppException(HttpStatus.SC_BAD_REQUEST, "IllegalArgumentException", message);
        }
    }

    public static void isTrue(boolean expression, Supplier<String> messageSupplier) {
        if (!expression) {
            throw new AppException(HttpStatus.SC_BAD_REQUEST, "IllegalArgumentException", nullSafeGet(messageSupplier));
        }
    }
    ...
    private static void instanceCheckFailed(Class<?> type, @Nullable Object obj, @Nullable String msg) {
        ...
        throw new AppException(HttpStatus.SC_BAD_REQUEST, "IllegalArgumentException", result);
    }
