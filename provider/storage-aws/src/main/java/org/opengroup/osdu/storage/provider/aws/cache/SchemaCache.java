...
public class SchemaCache extends RedisCache<String, Schema> {
    ...
    public SchemaCache(@Value("${aws.elasticache.cluster.schema.endpoint}") final String REDIS_SCHEMA_HOST, @Value("${aws.elasticache.cluster.schema.port}") final String REDIS_SCHEMA_PORT) {
