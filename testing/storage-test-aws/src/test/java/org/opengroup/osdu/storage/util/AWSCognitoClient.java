...
public class AWSCognitoClient {
    public static String getTokenForUserWithAccess(){
        String clientId = System.getProperty("AWS_COGNITO_CLIENT_ID");
        String authFlow = System.getProperty("AWS_COGNITO_AUTH_FLOW");
        Map<String, String> authParameters = new HashMap<>();
        authParameters.put("USERNAME", System.getProperty("AWS_COGNITO_AUTH_PARAMS_USER"));
        authParameters.put("PASSWORD", System.getProperty("AWS_COGNITO_AUTH_PARAMS_PASSWORD"));
    ...
    public static String getTokenForUserWithNoAccess(){
        ...
        String authFlow = System.getProperty("AWS_COGNITO_AUTH_FLOW");
        Map<String, String> authParameters = new HashMap<>();
        authParameters.put("USERNAME", System.getProperty("AWS_COGNITO_AUTH_PARAMS_USER_NO_ACCESS"));
        authParameters.put("PASSWORD", System.getProperty("AWS_COGNITO_AUTH_PARAMS_PASSWORD"));
