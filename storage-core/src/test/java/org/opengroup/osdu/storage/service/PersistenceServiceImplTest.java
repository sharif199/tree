...
public class PersistenceServiceImplTest {
    ...
    @Test
    public void should_notPersistRecords_and_throw413AppException_when_datastoreErrorOccur() {
        TransferBatch batch = this.createBatchTransfer();

        this.setupRecordRepository(23, 10, 25);
        doThrow(new AppException(413, "Request too large", "Request too large")).when(this.recordRepository).createOrUpdate(any());
